...
@section('breadcrumb')
    ...
    <li class="active">Retensi Inaktif</li>
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <button class="btn btn-darkorange" onclick="location.href='{{ route('retensi_inaktif.create') }}'"><i class="fa fa-plus"> Tambah Data</i></button><hr>
                    @endif
                    <table class="table bordered-darkorange table-striped table-bordered table-hover responsive" id="tblRetensi" width="100%">
