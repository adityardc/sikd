                ...
                <ul class="nav nav-tabs nav-justified" id="myTab5">
                    <li class="active">
                        <a data-toggle="tab" href="#home1">
                            Detail Surat Keluar Direksi Internal
                        </a>
                    </li>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            @if($data->file_surat == NULL)
                                                File tidak tersedia !
                                            @else
                                                <a href="{{ asset($data->file_surat) }}" target="_blank" class='btn btn-danger'><i class='fa fa-download'></i> Download File</a>
                                            @endif
                                            <button type="button" class="btn btn-yellow" onclick="location.href='{{ route('surat_keluar_direksi_internal') }}'">Kembali</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <table class="table table-hover table-bordered">
                                            <thead>
                                                ...
                                                <th style="width: 10%">Nama Bagian/Unitkerja</th>
                                                <th style="width: 10%;text-align: center;">No. Agenda Sentral</th>
                                                <th style="width: 10%;text-align: center;">Tgl. Agenda Sentral</th>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{ $row->nomor_agenda_sentral }}</td>
                                                    <td style="text-align: center;">{{ date('d M Y', strtotime($row->tanggal_agenda_sentral)) }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table><br>
