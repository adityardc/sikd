...
@section('breadcrumb')
    ...
    <li class="active">Laporan Disposisi Surat Keluar Direksi</li>
@endsection

@section('title')
    Halaman Laporan Disposisi Surat Keluar Direksi
@endsection
...
@section('content')
        ...
        <div class="col-lg-5 col-sm-5 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-azure">
                    <span class="widget-caption">Pencarian Disposisi Surat Keluar Direksi</span>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-azure">
                    <span class="widget-caption">Tabel Disposisi Surat Keluar Direksi</span>
                </div>
                <div class="widget-body">
                    <p class="text-center"><img src="{{ asset('assets/img/Ellipsis.gif') }}" id="imgLoader"></p>
                    <table class="table bordered-azure table-striped table-bordered table-hover responsive" id="tblSuratdireksi" width="100%">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function detail(id){
            ...
            $.ajax({
                url: "laporan_disposisi_direksi_sk/"+id+"/detail",
                type: "GET",
                beforeSend: function(){
                    $('#imgLoader').show();
                },
        ...
        $(document).ready(function(){
            ...
            var oTableSurat = $('#tblSuratdireksi').dataTable({
                ...
                "ajax": {
                    "url": "{{ route('lap_disposisi_dir_sk.data') }}",
                    // "type": "GET",
                    "data": function(d){
