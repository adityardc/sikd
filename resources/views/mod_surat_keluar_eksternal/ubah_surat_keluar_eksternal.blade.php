        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frmEksternal" enctype="multipart/form-data" method="POST" action="{{ $url }}">
                        {{ csrf_field() }}
                        <div class="row">
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="2" id="tujuan_surat" name="tujuan_surat" onkeyup="upTujuan()" maxlength="100">{{ $data->tujuan_surat }}</textarea>
                                        </div>
                                        <div class="form-group">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        // Function upper input tujuan surat
        function upTujuan(){
        ...
        $(document).ready(function(){
            ...
            var tgl_surat = $('#tanggal_surat').datepicker({
                ...
                tgl_surat.hide();
                $('#frmEksternal').bootstrapValidator('revalidateField', 'tanggal_surat');
            }).data('datepicker');

            $('#frmEksternal').find('[name="tujuan_surat[]"]').chosen().change(function(e){
                $('#frmEksternal').bootstrapValidator('revalidateField', 'tujuan_surat[]');
