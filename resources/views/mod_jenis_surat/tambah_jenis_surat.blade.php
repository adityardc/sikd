                ...
                <div class="widget-body">
                	<form class="bv-form" role="form" id="frmJenissurat" novalidate="novalidate" method="POST" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_jenis" id="nama_jenis" maxlength="20" onkeyup="upNama()" autofocus>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="form-group">
                                    <label for="kode_jenis">Kode Jenis</label>
                                    <input type="text" class="form-control" name="kode_jenis" id="kode_jenis" maxlength="5" onkeyup="upKode()">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="form-group">
