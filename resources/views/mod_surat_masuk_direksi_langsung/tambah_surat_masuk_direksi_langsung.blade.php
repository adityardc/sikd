...
@section('breadcrumb')
    ...
    <li>Surat Masuk Direksi Langsung</li>
...
@section('content')
    <div class="row">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_internal" method="POST" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-yellow" id="btnBatal" onclick="location.href='{{ route('surat_masuk_direksi_langsung') }}'">Batal/Kembali</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-lg-6 col-sm-6 col-lg-6 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-darkorange">
                    <span class="widget-caption">Detail Surat Masuk Direksi Langsung</span>
                </div>
                <div class="widget-body">
                    <form class="bv-form" role="form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @else
                                        <a href="{{ asset($data->file_surat) }}" target="_blank" class='btn btn-darkorange'><i class='fa fa-download'></i> Download File</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" disabled>{{ $data->nama_bagian }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="tujuan_surat">Tujuan Surat</label>
                            <textarea class="form-control" rows="2" id="tujuan_surat" name="tujuan_surat" disabled>{{ $data->tujuan_surat }}</textarea>
                        </div>
                        @endif
                        <div class="form-group">
