...
@section('title')
    Halaman Ubah Surat Keluar Internal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-palegreen">
                    <span class="widget-caption">Form Ubah Surat Keluar Internal</span>
                </div>
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_internal" method="POST" action="{{ $url }}" novalidate="novalidate">
