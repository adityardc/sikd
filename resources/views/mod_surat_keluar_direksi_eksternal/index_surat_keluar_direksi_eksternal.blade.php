...
@section('breadcrumb')
    ...
    <li class="active">Surat Keluar Direksi Eksternal</li>
@endsection
            ...
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-purple">
                    ...
                    <div class="widget-buttons buttons-bordered">
                        <button class="btn btn-purple btn-sm" onclick="location.href='{{ route('surat_keluar_direksi_eksternal.create') }}'"><i class='fa fa-plus'></i> Tambah Data</button>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var oTableSurat = $('#tbl_sk_dir_eks').dataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "{{ route('surat_keluar_direksi_eksternal.data') }}",
                    "type": "GET"
                },
                "aoColumnDefs": [{
                    "aTargets": [0,1,6,7,8],
