...
@section('breadcrumb')
    ...
    <li>Surat Keluar Internal</li>
    <li class="active">Tambah Data Surat Keluar Internal</li>
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_internal" enctype="multipart/form-data" method="POST" action="{{ $url }}">
                        {{ csrf_field() }}
                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jns_tujuan" id="jns_tujuan">
                                                ...
                                                @foreach($tim as $rowTim)
                                                    <option value="{{ $rowTim->id_tim }}">{{ $rowTim->nama_tim }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-yellow" id="btnBatal" onclick="location.href='{{ route('surat_keluar_internal') }}'">Batal/Kembali</button>
                                            <input type="text" class="form-control" id="id_klasifikasi" name="id_klasifikasi" readonly="true" style="display: none;">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#jns_tujuan').change(function(){
                ...
                $('#frm_internal').bootstrapValidator('disableSubmitButtons', false);
            });
            ...
            $('#frm_internal').find('[name="tujuan_surat[]"]').chosen().change(function(e){
                $('#frm_internal').bootstrapValidator('revalidateField', 'tujuan_surat[]');
            }).end().find('[name="id_konseptor"]').chosen().change(function(e){
                $('#frm_internal').bootstrapValidator('revalidateField', 'id_konseptor');
                ...
                fields: {
                    ...
                    id_konseptor: {
                        validators: {
                            callback: {
                                message: 'Pilih 1 konseptor',
                                callback: function(value, validator) {
                                    var options = validator.getFieldElements('id_konseptor').val();
                                    return (options != null && options.length >= 1);
                                }
                            },
                            notEmpty: {
