...
@section('title')
    Halaman Input Surat Keluar Eksternal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_eksternal" novalidate="novalidate">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#frm_eksternal').bootstrapValidator({
                ...
                $.ajax({
                    url: "{{ route('surat_keluar_eks.simpan') }}",
                    type: "POST",
                    data: $('#frm_eksternal').serialize(),
                    dataType: 'JSON',
                    beforeSend: function(){
                        $('#imgLoader').show();
                    },
                ...
                $('#frm_eksternal').bootstrapValidator('disableSubmitButtons', false).bootstrapValidator('resetForm', true);
            });
        });
    </script>
@endsection