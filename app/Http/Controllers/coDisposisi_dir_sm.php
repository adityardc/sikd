...
class coDisposisi_dir_sm extends Controller
{
    public function index()
    {
    	...
    	return view('disposisi_dir_sm', compact(['dir','dispo','bag']));
    }
    ...
    public function disposisi($id)
    {
        ...
        $detail = DB::table('tbl'.$x)->select('nomor_surat','perihal')->where('id'.$x, $surat->id_surat_masuk_keluar)->first();
        $url = url('disposisi_direksi_sm/'.$id.'/update');
        ...
        $dispo = DB::table('tbl_disposisi_direksi')->orderBy('id_disposisi_direksi')->get();
        return view('form_ubah/edit_disposisi_dir_sm', compact(['surat','url','selected_disposisi','selected_tujuan','detail','dir','bag','dispo']));
    }
    ...
    public function update(Request $request, $id)
    {
    	...
    	return Redirect::to('disposisi_direksi_sm')->with('message', 'Data berhasil diubah.');
    }
}
