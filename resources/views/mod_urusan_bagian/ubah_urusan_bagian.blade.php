                	...
                	<div id="horizontal-form">
                		<form class="form-horizontal bv-form" role="form" id="frmUrusan" novalidate="novalidate" method="POST" action="{{ $url }}">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="id_bagian" id="id_bagian">
                                        @foreach($bagian as $row)
                                            <option value="{{ $row->id_bagian }}" {{ $data->id_bagian == $row->id_bagian ? 'selected="selected"' : '' }}>{{ $row->nama_bagian }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="nama_urusan_bagian" id="nama_urusan_bagian" onkeyup="upUrusan()" maxlength="150" value="{{ $data->nama_urusan_bagian }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="status_urusan_bagian" id="status_urusan_bagian">
                                        <option value="Y" {{ $data->status_urusan_bagian == "Y" ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="N" {{ $data->status_urusan_bagian == "N" ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
