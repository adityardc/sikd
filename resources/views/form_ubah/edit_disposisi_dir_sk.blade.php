...
@section('breadcrumb')
    ...
    <li class="active">Surat Masuk Keluar</li>
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-azure">
                    <span class="widget-caption">Form Disposisi Direksi - Surat Keluar</span>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-md-8 col-xs-12">
                                        <div class="form-group">
                                            <label for="uraian_disposisi">Keterangan</label>
                                            <textarea class="form-control" rows="2" id="keterangan" name="keterangan" onkeyup="upKeterangan()">{{ $detail->keterangan }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-yellow" id="btnBatal" onclick="location.href='{{ route('disposisi_direksi_sk') }}'">Batal</button>
                                    ...
                                    <input type="text" name="id_surat_masuk_keluar" id="id_surat_masuk_keluar" class="form-control" style="display: none;" value="{{ $surat->id_surat_masuk_keluar }}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                <div class="row">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        // FUNCTION UPPER KETERANGAN DISPOSISI
        function upKeterangan(){
            var i = document.getElementById("keterangan");
            i.value = i.value.toUpperCase();
        }
