                ...
                <div class="widget-body">
                	<form class="bv-form" role="form" id="frmPendidikan" novalidate="novalidate" method="POST" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_pendidikan" id="nama_pendidikan" maxlength="50" onkeyup="upNama()" autofocus value="{{ $data->nama_pendidikan }}">
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_pendidikan" id="status_pendidikan">
                                        <option value="Y" {{ $data->status_pendidikan == "Y" ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="N" {{ $data->status_pendidikan == "N" ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
