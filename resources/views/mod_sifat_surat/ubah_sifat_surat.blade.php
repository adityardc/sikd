                        ...
                        <div class="row">
                            <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_sifat" id="nama_sifat" maxlength="20" onkeyup="upNama()" autofocus value="{{ $data->nama_sifat }}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                                <div class="form-group">
                                    <label for="kode_sifat">Kode Sifat</label>
                                    <input type="text" class="form-control" name="kode_sifat" id="kode_sifat" maxlength="5" onkeyup="upKode()" value="{{ $data->kode_sifat }}">
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_sifat" id="status_sifat">
                                        <option value="Y" {{ $data->status_sifat == "Y" ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="N" {{ $data->status_sifat == "N" ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
