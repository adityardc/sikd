...
@section('title')
    Halaman Input Surat Keluar Internal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_internal" novalidate="novalidate">
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-yellow" id="btnBatal" onclick="location.href='{{ route('surat_keluar_int') }}'">Batal</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var oTableKlasifikasi = $('#tblKlasifikasi').dataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "{{ route('surat_keluar_int.klasifikasi') }}",
                    "type": "GET"
                },
                "aoColumnDefs": [{
                    "aTargets": [0],
            ...
            $('#frm_internal').find('[name="nama_tujuan[]"]').chosen().change(function(e){
                $('#frm_internal').bootstrapValidator('revalidateField', 'nama_tujuan[]');
                ...
                $.ajax({
                    url: "{{ route('surat_keluar_int.simpan') }}",
                    type: "POST",
                    data: $('#frm_internal').serialize(),
                    dataType: 'JSON',
                    beforeSend: function(){
                        $('#imgLoader').show();
                    },
                ...
                $('#frm_internal').bootstrapValidator('disableSubmitButtons', false).bootstrapValidator('resetForm', true);
            });
        });
    </script>
@endsection