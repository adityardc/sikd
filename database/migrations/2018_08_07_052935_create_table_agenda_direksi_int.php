...
class CreateTableAgendaDireksiInt extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_agenda_direksi_int', function(Blueprint $table){
            $table->increments('id_agenda_direksi_int');
