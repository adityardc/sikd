...
@section('breadcrumb')
    ...
    <li class="active">Laporan Surat Masuk Eksternal - Sentral</li>
@endsection

@section('title')
    Halaman Laporan Surat Masuk Eksternal - Sentral
@endsection
...
@section('content')
        ...
        <div class="col-lg-5 col-sm-5 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-maroon">
                    <span class="widget-caption">Pencarian Surat Masuk Direksi Eksternal - Sentral</span>
                </div>
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frmCari" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-maroon" id="btnTampil">Tampilkan</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-maroon">
                    <span class="widget-caption">Tabel Surat Masuk Direksi Eksternal - Sentral</span>
                </div>
                <div class="widget-body">
                    <p class="text-center"><img src="{{ asset('assets/img/Ellipsis.gif') }}" id="imgLoader"></p>
                    <table class="table bordered-maroon table-striped table-bordered table-hover responsive" id="tbl_sm_eks" width="100%">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function detail(id){
            ...
            $.ajax({
                url: "laporan_surat_masuk_eksternal/"+id+"/detail",
                type: "GET",
                beforeSend: function(){
                    $('#imgLoader').show();
                },
