                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            @if($data->file_surat == NULL)
                                                File tidak tersedia !
                                            @else
                                                <a href="{{ asset($data->file_surat) }}" target="_blank" class='btn btn-magenta'><i class='fa fa-download'></i> Download File</a>
                                            @endif
                                            <button type="button" class="btn btn-yellow" onclick="location.href='{{ route('surat_keluar_eksternal') }}'">Kembali</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
