                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frmRetensi" novalidate="novalidate" method="POST" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_ket" id="nama_ket" maxlength="150" onkeyup="upNama()" autofocus value="{{ $data->nama_ket }}">
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_ket" id="status_ket">
                                        <option value="Y" {{ $data->status_ket == "Y" ? 'selected="selected"' : '' }}>Aktif</option>
                                        <option value="N" {{ $data->status_ket == "N" ? 'selected="selected"' : '' }}>Tidak Aktif</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-yellow" id="btnBatal" onclick="location.href='{{ route('retensi_deskripsi') }}'">Batal/Kembali</button>
                        </div>
                    </form>
                </div>
            </div>
