...
@section('breadcrumb')
    ...
    <li class="active">Laporan Surat Keluar Direktur Eksternal</li>
@endsection

@section('title')
    Halaman Laporan Surat Keluar Direktur Eksternal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-sky">
                    <span class="widget-caption">Tabel Surat Keluar Direktur Eksternal</span>
                </div>
                <div class="widget-body">
                    <p class="text-center"><img src="{{ asset('assets/img/Ellipsis.gif') }}" id="imgLoader"></p>
                    <table class="table bordered-azure table-striped table-bordered table-hover responsive" id="tbl_sk_dir_eks" width="100%">
        ...
        <div class="modal-dialog modal-primary">
            <div class="modal-content">
                <div class="modal-header bordered-sky">
                    ...
                    <h4 class="modal-title" id="mySmallModalLabel">Detail Surat Keluar Direksi Eksternal</h4>
                </div>
...
@section('script')
    ...
    <script type="text/javascript">
        function detail(id){
            ...
            $.ajax({
                url: "laporan_sk_direksi_eksternal/"+id+"/detail",
                type: "GET",
                beforeSend: function(){
                    $('#imgLoader').show();
                },
