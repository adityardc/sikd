                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan" maxlength="150" onkeyup="upNama()" autofocus value="{{ old('nama_karyawan') }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="tanggal_lahir">Tanggal Lahir</label>
                                                    <input type="text" class="form-control tgl" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}">
                                                </div>  
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="tanggal_karyawan">Tanggal Pengangkatan</label>
                                                    <input type="text" class="form-control tgl" id="tanggal_karyawan" name="tanggal_karyawan" value="{{ old('tanggal_karyawan') }}">
                                                </div>  
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" data-bv-field="email" maxlength="150" value="{{ old('email') }}">
                                                </div>  
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="bagian" id="bagian">
                                                @foreach($bagian as $rowBagian)
                                                    <option value="{{ $rowBagian->id_bagian }}" {{ (old('bagian') == $rowBagian->id_bagian ? "selected":"") }}>{{ $rowBagian->nama_bagian }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jabatan" id="jabatan">
                                                @foreach($jbt as $rowJabatan)
                                                    <option value="{{ $rowJabatan->id_jabatan }}" {{ (old('jabatan') == $rowJabatan->id_jabatan ? "selected":"") }}>{{ $rowJabatan->nama_jabatan }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="row">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="golongan" id="golongan">
                                                        @foreach($gol as $rowGolongan)
                                                            <option value="{{ $rowGolongan->id_golongan }}" {{ (old('golongan') == $rowGolongan->id_golongan ? "selected":"") }}>{{ $rowGolongan->nama_golongan }}</option>
                                                        @endforeach
                                                    </select>
                                                </div> 
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pendidikan" id="pendidikan">
                                                        @foreach($ddk as $rowPendidikan)
                                                            <option value="{{ $rowPendidikan->id_pendidikan }}" {{ (old('pendidikan') == $rowPendidikan->id_pendidikan ? "selected":"") }}>{{ $rowPendidikan->nama_pendidikan }}</option>
                                                        @endforeach
                                                    </select>
                                                </div> 
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status_konseptor" id="status_konseptor">
                                                        <option value="1" {{ (old('status_konseptor') == "1" ? "selected":"") }}>Aktif</option>
                                                        <option value="2" {{ (old('status_konseptor') == "2" ? "selected":"") }}>Tidak Aktif</option>
                                                    </select>
                                                </div> 
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status_karyawan" id="status_karyawan">
                                                        <option value="1" {{ (old('status_karyawan') == "1" ? "selected":"") }}>Aktif</option>
                                                        <option value="2" {{ (old('status_karyawan') == "2" ? "selected":"") }}>Tidak Aktif</option>
                                                    </select>
                                                </div> 
                                            </div>
                                        </div>
