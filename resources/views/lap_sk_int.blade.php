...
@section('breadcrumb')
    ...
    <li class="active">Laporan Surat Keluar Internal</li>
@endsection

@section('title')
    Halaman Laporan Surat Keluar Internal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <table class="table bordered-sky table-striped table-bordered table-hover responsive" id="tbl_sk_int" width="100%">
...
@section('script')
    ...
    <script type="text/javascript">
        function detail(id){
            ...
            $.ajax({
                url: "laporan_sk_internal/"+id+"/detail",
                type: "GET",
                beforeSend: function(){
                    $('#imgLoader').show();
                },
