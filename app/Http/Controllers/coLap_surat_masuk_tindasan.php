...
class coLap_surat_masuk_tindasan extends Controller
{
    public function index()
    {
    	return view('lap_surat_masuk_tindasan');
    }
    ...
    public function list()
    {
        ...
        $konseptor = DB::table("tbl_surat_keluar")
                    // ->where('jenis_surat', 0)
                    ->whereRaw("((',' || RTRIM(tindasan) || ',') LIKE '%,".$id_asal.",%')
                                    AND jenis_surat = 0")
    ...
    public function detail($id)
    {
        ...
        return view('modal/modal_detailLap_surat_masuk_tindasan', compact(['detail','tindasan','tujuan']));
    }
}
