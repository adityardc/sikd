...
@section('title')
    Halaman Input Surat Keluar Direktur Eksternal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_dir_eksternal" novalidate="novalidate">
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="2" id="nama_tujuan" name="nama_tujuan" onkeyup="upTujuan()" maxlength="150"></textarea>
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="perihal" name="perihal" onkeyup="upPerihal()"></textarea>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var oTableKlasifikasi = $('#tblKlasifikasi').dataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "{{ route('surat_keluar_direktur_eksternal.klasifikasi') }}",
                    "type": "GET"
                },
                "aoColumnDefs": [{
                    "aTargets": [0],
            ...
            $('#frm_dir_eksternal').bootstrapValidator({
                ...
                $.ajax({
                    url: "{{ route('surat_keluar_direktur_eksternal.simpan') }}",
                    type: "POST",
                    data: $('#frm_dir_eksternal').serialize(),
                    dataType: 'JSON',
                    beforeSend: function(){
                        $('#imgLoader').show();
                    },
                ...
                $('#frm_dir_eksternal').bootstrapValidator('disableSubmitButtons', false).bootstrapValidator('resetForm', true);
            });
        });
    </script>
@endsection