                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frmJenis" novalidate="novalidate" method="POST" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_disposisi_bagian" id="nama_disposisi_bagian" maxlength="150" onkeyup="upNama()" autofocus value="{{ $data->nama_disposisi_bagian }}">
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_disposisi_bagian" id="status_disposisi_bagian">
                                        <option value="Y" {{ $data->status_disposisi_bagian == "Y" ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="N" {{ $data->status_disposisi_bagian == "N" ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
