...
class coAgenda_direksi_langsung extends Controller
{
    public function index()
    {
    	...
    	return view('agenda_direksi_langsung', compact(['agenda','tujuan','sifat','jenis']));
    }
    ...
    public function agenda_direksi_langsung($id)
    {
        ...
        return view('modal/modal_agendadireksi_langsung', compact(['detail','tindasan','tujuan']));
    }
