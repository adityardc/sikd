...
@section('title')
    Halaman Ubah Surat Keluar Karyawan
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-sky">
                    <span class="widget-caption">Form Ubah Surat Keluar Karyawan</span>
                </div>
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_karyawan" method="POST" action="{{ $url }}" novalidate="novalidate">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="nama_tujuan" name="nama_tujuan[]" multiple="multiple" data-placeholder="Pilih Karyawan . . .">
                                                <option value=""></option>
                                                @foreach($kry as $row)
                                                    <option value="{{ $row->id_karyawan }}" {{ (in_array($row->id_karyawan, $selected_tujuan)) ? 'selected' : '' }}>{{ $row->nama_karyawan }}</option>
                                                @endforeach
                                            </select>
