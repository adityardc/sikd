...
@section('breadcrumb')
    ...
    <li class="active">Surat Keluar Direktur Internal</li>
@endsection

@section('title')
    Halaman Input Surat Keluar Direktur Internal
@endsection
        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-danger">
                    <span class="widget-caption">Form Surat Keluar Direktur Internal</span>
                </div>
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_dir_internal" novalidate="novalidate">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-btn">
                                                            <button class="btn btn-danger" type="button" id="btnKlasifikasi" data-toggle="modal" data-target="#modalKlasifikasi"><i class="fa fa-search-plus"></i></button>
                                                        </span>
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#modalKonseptor"><i class="fa fa-search-plus"></i></button>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-yellow" id="btnBatal" onclick="location.href='{{ route('surat_keluar_direktur_internal') }}'">Batal</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-panjang">
                    <div class="table-responsive">
                        <table class="table bordered-danger table-striped table-bordered table-hover" id="tblKlasifikasi" width="100%">
    ...
    <div class="modal fade bs-example-modal-sm" id="modalKonseptor" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-panjang">
                    <div class="table-responsive">
                        <table class="table bordered-danger table-striped table-bordered table-hover" id="tblKonseptor" width="100%">
                            <thead class="bordered-danger">
                                <th class="text-center">No</th>
                                <th class="text-center">Aksi</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var oTableKlasifikasi = $('#tblKlasifikasi').dataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "{{ route('surat_keluar_direktur_internal.klasifikasi') }}",
                    "type": "GET"
                },
                "aoColumnDefs": [{
                    "aTargets": [0],
            ...
            var oTableKonseptor = $('#tblKonseptor').dataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": "{{ route('surat_keluar_direktur_internal.konseptor') }}",
                    "type": "GET"
                },
                "aoColumnDefs": [{
                    "aTargets": [0],
            ...
            $('#tblKlasifikasi tbody').on('click', '.btnPilihKlas', function(){
                ...
                $('#frm_dir_internal').bootstrapValidator('revalidateField', 'kode_klasifikasi');
            ...
            $('#tblKonseptor tbody').on('click', '.btnPilihKonseptor', function(){
                ...
                $('#frm_dir_internal').bootstrapValidator('revalidateField', 'konseptor');
            ...
            $('#frm_dir_internal').find('[name="nama_tujuan[]"]').chosen().change(function(e){
                $('#frm_dir_internal').bootstrapValidator('revalidateField', 'nama_tujuan[]');
                ...
                $.ajax({
                    url: "{{ route('surat_keluar_direktur_internal.simpan') }}",
                    type: "POST",
                    data: $('#frm_dir_internal').serialize(),
                    dataType: 'JSON',
                    beforeSend: function(){
                        $('#imgLoader').show();
                    },
                ...
                $('#frm_dir_internal').bootstrapValidator('disableSubmitButtons', false).bootstrapValidator('resetForm', true);
            });
        });
    </script>
@endsection