                ...
                <div class="widget-body">
            		<form class="bv-form" role="form" id="frmBagian" novalidate="novalidate" method="POST" action="{{ $url }}">
            			...
            			<div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_bagian" id="nama_bagian" maxlength="150" onkeyup="upNama()" autofocus value="{{ $data->nama_bagian }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                <div class="form-group">
                                    <label for="kode_bagian"">Kode Bagian</label>
                                    <input type="text" class="form-control" name="kode_bagian" id="kode_bagian" maxlength="10" onkeyup="upKode()" value="{{ $data->kode_bagian }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="grup_bagian" id="grup_bagian">
                                        <option value="0" {{ $data->grup_bagian == 0 ? 'selected="selected"' : '' }}>DIREKSI</option>
                                        <option value="1" {{ $data->grup_bagian == 1 ? 'selected="selected"' : '' }}>BAGIAN KANTOR DIREKSI</option>
                                        <option value="2" {{ $data->grup_bagian == 2 ? 'selected="selected"' : '' }}>UNIT KERJA</option>
                                        <option value="3" {{ $data->grup_bagian == 3 ? 'selected="selected"' : '' }}>AGROWISATA</option>
                                        <option value="4" {{ $data->grup_bagian == 4 ? 'selected="selected"' : '' }}>LAIN - LAIN</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tindasan" id="tindasan">
                                        <option value="1" {{ $data->tindasan == 1 ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="0" {{ $data->tindasan == 0 ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_bagian" id="status_bagian">
                                        <option value="Y" {{ $data->status_bagian == "Y" ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="N" {{ $data->status_bagian == "N" ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                        </div>                                
