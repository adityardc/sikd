                ...
                <div class="widget-body">
                	<form class="bv-form" role="form" id="frmMasakerja" novalidate="novalidate" method="POST" action="{{ $url }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_masakerja" id="nama_masakerja" maxlength="50" onkeyup="upNama()" autofocus value="{{ $data->nama_masakerja }}">
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_masakerja" id="status_masakerja">
                                        <option value="Y" {{ $data->status_masakerja == "Y" ? 'selected="selected"' : '' }}>AKTIF</option>
                                        <option value="N" {{ $data->status_masakerja == "N" ? 'selected="selected"' : '' }}>TIDAK AKTIF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
