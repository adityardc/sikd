        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frmInternal" enctype="multipart/form-data" method="POST" action="{{ $url }}">
                        {{ csrf_field() }}
                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var tgl_surat = $('#tanggal_surat').datepicker({
                ...
                tgl_surat.hide();
                $('#frmInternal').bootstrapValidator('revalidateField', 'tanggal_surat');
            }).data('datepicker');

            $('#frmInternal').find('[name="tujuan_surat[]"]').chosen().change(function(e){
                $('#frmInternal').bootstrapValidator('revalidateField', 'tujuan_surat[]');
