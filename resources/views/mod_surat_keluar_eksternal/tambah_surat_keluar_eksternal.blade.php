        ...
        <div class="col-lg-12 col-sm-12 col-lg-12 col-xs-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <form class="bv-form" role="form" id="frm_eksternal" enctype="multipart/form-data" method="POST" action="{{ $url }}">
                        {{ csrf_field() }}
                        <div class="row">
                                ...
                                <div class="widget flat">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="2" id="tujuan_surat" name="tujuan_surat" onkeyup="upTujuan()" maxlength="100"></textarea>
                                        </div>
                                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#tblKlasifikasi tbody').on('click', '.btnPilihKlas', function(){
                ...
                $('form#frm_eksternal').bootstrapValidator('revalidateField', 'kode_klasifikasi');
